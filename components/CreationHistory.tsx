        ...
        {history.map((item) => {
          return (
            <button
              ...
              className="group flex-shrink-0 relative flex flex-col text-left w-48 bg-zinc-900/50 hover:bg-zinc-800 border border-zinc-800 hover:border-zinc-600 rounded-lg transition-all duration-200 overflow-hidden"
            >
